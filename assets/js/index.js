...
const payScoreUrl = `http://45.84.68.38:8082/system_api/?format=json&context=web&model=users&method1=web_cabinet.add_payment_operation&arg1={"suid":\"${sessionId}\", "contract_number": "${scoreId}", "summa_in": "100.00", "operator": "SBERBANK_ACQ"}`;
